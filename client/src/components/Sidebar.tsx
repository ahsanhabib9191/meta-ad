...
export default function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <aside className="flex h-full min-h-screen w-64 flex-col justify-between border-r border-solid border-gray-200 bg-gray-50 p-4">
      <div className="flex flex-col gap-8">
        <div className="flex items-center gap-3 px-3 text-primary">
          ...
          <h2 className="text-gray-900 text-xl font-bold leading-tight tracking-[-0.015em]">Shothik.ai</h2>
        </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        {user && (
          <div className="flex items-center gap-3 border-t border-solid border-gray-200 pt-4">
            <div
            ...
            <div className="flex flex-col">
              <h1 className="text-gray-900 text-sm font-medium leading-normal">{user.name}</h1>
              <p className={`text-xs font-normal leading-normal ${user.connected ? 'text-primary' : 'text-gray-400'}`}>
