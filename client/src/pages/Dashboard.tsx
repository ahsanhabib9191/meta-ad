        ...
        <div className="flex flex-col gap-8">
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="flex flex-col gap-4 rounded-lg border border-solid border-primary bg-emerald-100 p-5">
                <div className="flex items-center justify-between">
                  <h3 className="text-gray-900 text-base font-semibold">Primary Ad Account</h3>
                ...
                <div className="flex flex-col">
                  <p className="text-gray-900 text-lg font-medium">{mockData.primaryAdAccount.name}</p>
                  <p className="text-sm text-gray-600">ID: {mockData.primaryAdAccount.id}</p>
                </div>
              </div>
              <div className="flex flex-col gap-4 rounded-lg border border-solid border-primary bg-emerald-100 p-5">
                <div className="flex items-center justify-between">
                  <h3 className="text-gray-900 text-base font-semibold">Associated Pixel</h3>
                  <div className="flex items-center gap-2 rounded-full bg-white px-3 py-1 text-xs font-medium text-emerald-700">
                    <div className="size-2 rounded-full bg-emerald-500"></div>
                ...
                <div className="flex flex-col">
                  <p className="text-gray-900 text-lg font-medium">{mockData.associatedPixel.name}</p>
                  <p className="text-sm text-gray-600">ID: {mockData.associatedPixel.id}</p>
                </div>
              </div>
            </div>
          </div>
