...
async function run() {
    ...
    try {
        await ad_set_1.AdSetModel.create({
            ...
            status: 'INVALID_STATUS', // Force invalid value
            budget: 50,
    ...
    try {
        await ad_set_1.AdSetModel.create({
            ...
            status: 'ACTIVE',
            budget: 50,
            learningPhaseStatus: 'INVALID_PHASE', // Force invalid value
            optimizationGoal: 'PURCHASE',
        });
    ...
    try {
        await ad_1.AdModel.create({
            ...
            status: 'INVALID_AD_STATUS', // Force invalid value
            creative: {},
    ...
    try {
        await ad_1.AdModel.create({
            ...
            status: 'ACTIVE',
            creative: {},
            effectiveStatus: 'INVALID_EFFECTIVE', // Force invalid value
        });
    ...
    const adSetNoTargeting = await ad_set_1.AdSetModel.create({
